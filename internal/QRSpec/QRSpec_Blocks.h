...
namespace QRSpec_Internal
{
	...
	const struct QRBVersionBlockInfo
	{
		QRBlockData EccStrength[4];
	};
	const struct _CodewordSplittingTable
	{
		QRBVersionBlockInfo Version[40];
	}static constexpr CodewordSplittingTable =
	{ {
